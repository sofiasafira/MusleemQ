...
class AyatKursiAdapter(private val modelBacaan: List<ModelBacaan>) : RecyclerView.Adapter<AyatKursiAdapter.ListViewHolder>() {
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): AyatKursiAdapter.ListViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.list_niat_shalat, viewGroup, false)
        return AyatKursiAdapter.ListViewHolder(view)
    }
