...
class ShalatJenazahAdapter(private val modelBacaan: List<ModelBacaan>) : RecyclerView.Adapter<ShalatJenazahAdapter.ListViewHolder>() {
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ShalatJenazahAdapter.ListViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.list_niat_shalat, viewGroup, false)
        return ShalatJenazahAdapter.ListViewHolder(view)
    }
